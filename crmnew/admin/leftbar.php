  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="assets/img/profiles/placeholderperson-circle.gif"  alt="" data-src="assets/img/profiles/placeholderperson-circle.gif" data-src-retina="assets/img/profiles/avatar2x.jpg" width="69" height="69" /> </div>
        <div class="user-info">
    ...
    <ul>	
	 ...
	 <li><a href="message-list.php"><span class="fa fa-file-text-o"></span> Messages</a></li>

          <li><a href="change-password.php"><span class="fa fa-file-text-o"></span> Change Password</a></li>
							 <li><a href="contact-requests.php"><span class="fa fa-users"></span> Contact Requests</a></li>
